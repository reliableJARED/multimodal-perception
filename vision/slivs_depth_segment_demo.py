...
# Import the new depth-aware segmentation classes
from depth_aware_segmentation import DepthAwareSAM2Processor, SLIVSDepthVisualizer
...
class SLIVSDepthSegmentDemo:
    ...
    def __init__(self):
        ...
        self.output_dir = "slivs_depth_segment_demo_output"
